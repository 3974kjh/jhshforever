				...
				answers: [
					{
						speaker: '신랑 김준형',
						tag: 'INTP',
						text: '차분하고 듬직하며 생각이 깊어요. 사람과 삶을 깊이 바라볼 줄 아는 사람입니다. 그리고 나만의 개그맨이라 함께 있으면 너무 즐겁습니다.'
					},
					{
						speaker: '신부 박소현',
						tag: 'ISFJ',
						text: '배려심 많고 무엇이든 똑부러지게 잘 하는 야무진 성격을 가지고 있어요. 밝은 에너지가 넘쳐 주변 사람들의 기분을 좋게 만들어주는 인간비타민 같은 존재입니다.'
					}
				]
			},
			{
				...
				answers: [
					{
						speaker: '함께',
						text: '지인의 소개로 처음 만나 서로의 생애 첫 소개팅을 통해 특별한 인연이 되었는데요. 처음 만난 날, 낮부터 밤까지 이야기를 나누며 즐거운 데이트를 이어나갔습니다.'
					}
				]
			},
			{
				...
				answers: [
					...
					{
						speaker: '신부 박소현',
						text: '발랄하고 사랑스러운 매력으로 언제나 주변을 환하게 만드는 사람이예요. 무엇이든 적극적으로 일하는 책임감과 다툼이 생겨도 먼저 손을 내미는 넓은 마음과 서로 닮은 가치관까지 큰 매력으로 다가왔습니다.'
					}
				]
			},
			{
				...
				answers: [
					{
						speaker: '함께',
						text: '서로를 믿고 의지하며 어떤 풍파가 찾아와도 함께 이겨내는 부부가 되고 싶어요.\n비 온 뒤에는 더 단단한 당과 맑은 아침이 찾아오듯, 언제나 긍정적인 마음으로 살아가려고 합니다.\n할머니, 할아버지가 되는 날까지도 서로를 당연하게 여기지 않고 이해와 감사, 존중을 잊지 않는 부부가 되고 싶습니다.'
					}
				]
			}
		]
